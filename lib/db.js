...
function updateSettings(containerColor, username, profilePicUrl, bio, pageTitle) {
    db.run(
        "INSERT OR REPLACE INTO settings (id, container_color, username, profile_pic_url, bio, page_title) VALUES (1, ?, ?, ?, ?, ?)",
        [containerColor, username, profilePicUrl, bio, pageTitle]
    );
}
